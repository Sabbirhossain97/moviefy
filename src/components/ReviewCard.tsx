...
const ReviewCard: React.FC<ReviewCardProps> = ({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg p-4 bg-gradient-to-r from-card/70 to-background/60 shadow border hover:scale-[1.01] transition-all duration-150 group relative">
      {/* Top section with user info, date, and options */}
      <div className="flex justify-between items-start">
        ...
        {/* Date and options in top right */}
        <div className="flex items-center gap-2 shrink-0">
          {/* Three-dot menu for edit/delete (only show for owner) */}
      ...
      {editingReviewId === r.id ? (
        ...
        <div className="text-sm text-muted-foreground whitespace-pre-line leading-relaxed ml-13">
          {r.review}
        </div>
      )}
    </div>
