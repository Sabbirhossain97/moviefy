                        ...
                        <div className="flex">
                            <div className="w-full relative">
                                <Input
                                    ...
                                    className="lg:hidden bg-muted placeholder:text-[14px] pr-16 h-10 border-muted-foreground/20 focus:border-movie-primary"
                                    value={searchQuery}
                                    onChange={(e) => {
                                ...
                                {showDropdown && suggestions.length > 0 && (
                                    <div className="absolute left-0 top-12 z-[1002] bg-muted border border-muted rounded-md w-full shadow-lg max-h-52 overflow-y-auto">
