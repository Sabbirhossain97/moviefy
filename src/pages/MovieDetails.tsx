...
const MovieDetails = () => {
  ...
  return (
    <div className="min-h-screen gradient-bg relative">
      <Header />
      {/* Backdrop and fade mask, cover about 35% of viewport height */}
      <div className="relative w-full h-[35vh] min-h-[230px] max-h-[380px] flex items-end overflow-hidden">
        {backdropUrl ? (
          <>
            <img
              src={backdropUrl}
      ...
      {/* Movie card and main info (left poster, right info) */}
      <main className="container relative z-20 max-w-5xl px-4 md:px-6 -mt-20 flex flex-col md:flex-row gap-8 bg-transparent">
        {/* LEFT - Large poster card with Wishlist heart overlay */}
        <div className="w-full md:w-[300px] shrink-0 flex flex-col items-center md:items-start z-10">
          {posterUrl ? (
            <div className="relative group rounded-xl shadow-lg">
              <img
                src={posterUrl}
                alt={movie.title}
                className="w-56 md:w-[290px] h-[420px] object-cover rounded-xl border-[5px] border-white/10 shadow-lg"
            ...
            <div className="w-56 h-[420px] bg-gray-700 rounded-xl flex items-center justify-center">
        ...
        <div className="flex-1 pt-2">
          ...
          {/* Meta row: rating, release, runtime, status */}
          ...
          {/* Actions: Set Reminder & Watch Trailer side by side */}
          ...
          {/* User personal rating (keep as before) */}
          <div className="mb-4">
      ...
      {similarMovies.length > 0 && (
        <section className="container mt-10 mb-4">
          ...
          <MovieSlider title="" movies={similarMovies.slice(0, 10)} />
        </section>
      )}
